...
.factory('stockControler', ['validate', '$q', 'connect','util', function (validate, $q, connect, util){
	...
	function getStock (uuid){
		...
		validate.process(dependencies, ['allConsumptions', 'stock'])
		.then(function (data){
