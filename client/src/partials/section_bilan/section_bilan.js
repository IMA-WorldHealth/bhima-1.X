...
.controller('sectionBilan', [
  ...
  function ($scope, $translate, validate, connect, messenger, appstate, uuid) {
    ...
    $scope.delete = function (sectionBilan) {
      connect.basicDelete('section_bilan', sectionBilan.id, 'id')
      .then(function () {
    ...
    $scope.save.edit = function () {
      ...
      connect.basicPost('section_bilan', [record], ['id'])
      .then(function (res) {
    ...
    $scope.save.new = function () {
      ...
      connect.basicPut('section_bilan', [record])
      .then(function (res) {
