...
.controller('stock.integration', StockIntegrationController);

StockIntegrationController.$inject = [
  '$scope', '$q', '$translate', '$location', '$routeParams', 'validate', 'connect',
  'appstate', 'messenger', 'uuid', 'util', 'appcache', '$http', 'SessionService'
];

function StockIntegrationController($scope, $q, $translate, $location, $routeParams, validate, connect, appstate, messenger, uuid, util, Appcache, $http, Session) {
  var dependencies = {},
