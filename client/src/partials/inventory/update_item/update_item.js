...
.controller('inventory.update', [
  ...
  'uuid',
  'util',
  function ($scope, $translate, validate, connect, messenger, liberror, uuid, util) {
    ...
    function submitUpdate() {
      ...
      connect.basicPost('inventory', [updateLine], ['uuid'])
      .then(function writeHistory() {
        ...
        return connect.basicPut('inventory_log', [history]);
      })
      .then(function () {
