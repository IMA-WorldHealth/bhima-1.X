...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 04 Septembre 2014 à 01:27
...
INSERT INTO `employee` (`id`, `code`, `prenom`, `name`, `postnom`, `sexe`, `dob`, `dateEmbauche`, `nbFemme`, `nbEnfant`, `grade`, `dailySalary`, `bank`, `bankAccount`, `adresse`, `phone`, `email`, `assignation`, `fonction_id`, `service_id`, `location_id`, `creditor_uuid`, `debitor_uuid`) VALUES
