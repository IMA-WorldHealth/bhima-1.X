...
var keys = {
  ...
  '`account`'                      : ' (`id`, `account_type_id`, `enterprise_id`, `account_number`, `account_txt`, `parent`, `fixed`, `locked`, `cc_id`, `created`) ',
  ...
  '`patient_group`'                : ' (`enterprise_id`, `uuid`, `price_list_uuid`, `name`, `note`) ',
