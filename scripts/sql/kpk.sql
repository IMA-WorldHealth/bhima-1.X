...
create table `sale` (
  `enterprise_id` smallint unsigned not null,
  `id`            int unsigned not null auto_increment,
  `cost`          decimal(19, 3) unsigned not null,
  `currency_id`   tinyint unsigned not null,
  `debitor_id`    int unsigned not null,
...
create table `sale_item` (
  ...
  `inventory_price`   decimal(19, 3), 
  `transaction_price` decimal(19, 3) not null,
  `debit`             decimal(19, 3) not null default 0,
  `credit`            decimal(19, 3) not null default 0,
...
create table `purchase` (
  ...
  `enterprise_id`     smallint unsigned not null,
  `cost`              decimal(19, 3) unsigned not null default '0',
  `currency_id`       tinyint unsigned not null,
  `creditor_id`       int unsigned not null,
...
create table `purchase_item` (
  ...
  `inventory_id`  int unsigned not null,
  `quantity`      int unsigned default '0',
  `unit_price`    decimal(10,3) unsigned not null,
  `total`         decimal(10,3) unsigned,
  primary key (`id`),
...
create table `cash_item` (
  ...
  `allocated_cost`  decimal(19,3) unsigned not null default 0.00,
...
create table `kpk`.`period_total` (
  ...
  `period_id`         mediumint unsigned not null,
  `account_id`        int unsigned not null,
  `credit`            decimal(19, 3) unsigned,
  `debit`             decimal(19, 3) unsigned,
  `locked`            boolean not null default 0,
