...
insert into `user` values
  (1,'admin','admin','System Administrator','','kpkdeveloper@gmail.com', 0);
...
insert into `debitor` (`id`, `group_id`, `text`) values
(1,2,'Debtor account for patient Ramona Porter'),
(2,2,'Debtor account for patient Anne Gill'),
(3,1,'Debtor account for patient Mindy Kennedy'),
(4,2,'Debtor account for patient Lynne Graham'),
(5,2,'Debtor account for patient Yolanda Davis'),
(6,3,'Debtor account for patient Sue Moss'),
(7,2,'Debtor account for patient Cynthia Walters'),
(8,2,'Debtor account for patient Steven Ray'),
(9,3,'Debtor account for patient Manuel Sanders'),
(10,2,'Debtor account for patient Alfredo Coleman'),
(11,3,'Debtor account for patient Antonia Moran'),
(12,2,'Debtor account for patient William Clark'),
(13,3,'Debtor account for patient Vincent Collier'),
(14,2,'Debtor account for patient Lisa Haynes'),
(15,2,'Debtor account for patient Kayla Pratt'),
(16,1,'Debtor account for patient Vicky Austin'),
(17,2,'Debtor account for patient Jody Munoz'),
(18,2,'Debtor account for patient Sophia May'),
(19,2,'Debtor account for patient Marcos Ford'),
(20,3,'Debtor account for patient Gerard George'),
(21,1,'Debtor account for patient Edwin Fields'),
(22,3,'Debtor account for patient Krystal Gordon'),
(23,3,'Debtor account for patient Ernest Carson'),
(24,3,'Debtor account for patient Shelly Boone'),
(25,3,'Debtor account for patient Rebecca Holt'),
(26,2,'Debtor account for patient Mathew Robinson'),
(27,1,'Debtor account for patient Tamara Shaw'),
(28,2,'Debtor account for patient Henry Alexander'),
(29,2,'Debtor account for patient Della Estrada'),
(30,3,'Debtor account for patient Whitney Pena'),
(31,2,'Debtor account for patient Patti Freeman'),
(32,3,'Debtor account for patient Sonja Williams'),
(33,3,'Debtor account for patient Marcia Young'),
(34,1,'Debtor account for patient Natalie Ruiz'),
(35,2,'Debtor account for patient Craig Sparks'),
(36,1,'Debtor account for patient Woodrow Martinez'),
(37,2,'Debtor account for patient Julius Lowe'),
(38,3,'Debtor account for patient Leland Underwood'),
(39,1,'Debtor account for patient Chester Yates'),
(40,3,'Debtor account for patient Ernesto Watson'),
(41,3,'Debtor account for patient Jill Hubbard'),
(42,2,'Debtor account for patient Nelson Barton'),
(43,2,'Debtor account for patient Harold Sherman'),
(44,2,'Debtor account for patient Bradford Reed'),
(45,3,'Debtor account for patient Krista Spencer'),
(46,3,'Debtor account for patient Willard Riley'),
(47,3,'Debtor account for patient Tyrone Butler'),
(48,2,'Debtor account for patient Gayle Taylor'),
(49,1,'Debtor account for patient Beulah Manning'),
(50,2,'Debtor account for patient Kathryn Payne');

insert into `patient` (`id`, `debitor_id`, `sex`, `first_name`, `last_name`, `dob`, `origin_location_id`, `current_location_id`) values
(1,1,"M","Ramona","Porter", "1918-06-01", 1, 1),
(2,2,"M","Anne","Gill", "1923-06-01", 1, 1),
(3,3,"F","Mindy","Kennedy", "1996-06-01", 1, 1),
(4,4,"M","Lynne","Graham", "1991-06-01", 1, 1),
(5,5,"F","Yolanda","Davis", "1971-06-01", 1, 1),
(6,6,"M","Sue","Moss", "1997-06-01", 1, 1),
(7,7,"F","Cynthia","Walters", "1978-06-01", 1, 1),
(8,8,"F","Steven","Ray", "1947-06-01", 1, 1),
(9,9,"M","Manuel","Sanders", "1909-06-01", 1, 1),
(10,10,"M","Alfredo","Coleman", "1914-06-01", 1, 1),
(11,11,"F","Antonia","Moran", "1903-06-01", 1, 1),
(12,12,"F","William","Clark", "1932-06-01", 1, 1),
(13,13,"F","Vincent","Collier", "1916-06-01", 1, 1),
(14,14,"M","Lisa","Haynes", "2004-06-01", 1, 1),
(15,15,"M","Kayla","Pratt", "1918-06-01", 1, 1),
(16,16,"M","Vicky","Austin", "1969-06-01", 1, 1),
(17,17,"F","Jody","Munoz", "1954-06-01", 1, 1),
(18,18,"M","Sophia","May", "2000-06-01", 1, 1),
(19,19,"M","Marcos","Ford", "1918-06-01", 1, 1),
(20,20,"F","Gerard","George", "1978-06-01", 1, 1),
(21,21,"F","Edwin","Fields", "2000-06-01", 1, 1),
(22,22,"F","Krystal","Gordon", "1972-06-01", 1, 1),
(23,23,"M","Ernest","Carson", "1960-06-01", 1, 1),
(24,24,"M","Shelly","Boone", "1968-06-01", 1, 1),
(25,25,"F","Rebecca","Holt", "1949-06-01", 1, 1),
(26,26,"F","Mathew","Robinson", "1987-06-01", 1, 1),
(27,27,"F","Tamara","Shaw", "1994-06-01", 1, 1),
(28,28,"F","Henry","Alexander", "2012-06-01", 1, 1),
(29,29,"M","Della","Estrada", "1940-06-01", 1, 1),
(30,30,"M","Whitney","Pena", "1999-06-01", 1, 1),
(31,31,"F","Patti","Freeman", "1918-06-01", 1, 1),
(32,32,"F","Sonja","Williams", "1944-06-01", 1, 1),
(33,33,"F","Marcia","Young", "1999-06-01", 1, 1),
(34,34,"M","Natalie","Ruiz", "2007-06-01", 1, 1),
(35,35,"F","Craig","Sparks", "1945-06-01", 1, 1),
(36,36,"M","Woodrow","Martinez", "1985-06-01", 1, 1),
(37,37,"F","Julius","Lowe", "1953-06-01", 1, 1),
(38,38,"F","Leland","Underwood", "2011-06-01", 1, 1),
(39,39,"M","Chester","Yates", "1998-06-01", 1, 1),
(40,40,"F","Ernesto","Watson", "1951-06-01", 1, 1),
(41,41,"F","Jill","Hubbard", "1999-06-01", 1, 1),
(42,42,"M","Nelson","Barton", "2013-06-01", 1, 1),
(43,43,"F","Harold","Sherman", "1940-06-01", 1, 1),
(44,44,"F","Bradford","Reed", "1988-06-01", 1, 1),
(45,45,"F","Krista","Spencer", "1919-06-01", 1, 1),
(46,46,"M","Willard","Riley", "1954-06-01", 1, 1),
(47,47,"M","Tyrone","Butler", "1932-06-01", 1, 1),
(48,48,"M","Gayle","Taylor", "1939-06-01", 1, 1),
(49,49,"M","Beulah","Manning", "1921-06-01", 1, 1),
(50,50,"M","Kathryn","Payne", "1960-06-01", 1, 1);
