...
\begin{figure}[h]
\begin{center}
\includegraphics[width=8cm]{pic/ComptExploitation.png}
\end{center}
...
\includegraphics[scale=0.7]{pic/Print.png} permet d'imprimer le rapport et le second \includegraphics[scale=0.7]{pic/refresh.png}.
...
\newpage
\section{Rapport Balance Mensuelle}
