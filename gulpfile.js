// bhima gulp file for building, linting, and testing the
// bhima application.
...
var clientPaths = {
  scripts : ['client/src/js/define.js', 'client/src/**/*.js', '!client/src/js/app.js'],
  styles  : ['client/src/partials/**/*.css', 'client/src/partials/**/**/*.css', 'src/css/*.css', '!src/css/*.min.css', 'src/css/grid/*.css'],
  assets  : ['client/src/assets/**/*'],
  static  : ['client/src/index.html', 'src/login.html', 'src/error.html', 'src/project.html', 'src/js/app.js', 'src/i18n/*', 'src/css/fonts/*', 'src/partials/**/*.html', 'src/css/images/*'],
