...
exports.compile = function (options) {
  ...
  var sql =
    ...
    '`src`.`position` AS `sectionResultPosition`, SUM(`gld`.`debit_equiv`) AS `generalLegderDebit`, SUM(`gld`.`credit_equiv`) AS `generalLegderCredit`, `fy`.`fiscal_year_txt` AS fiscal ' +
