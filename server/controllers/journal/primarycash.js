...
function transfer(id, userId, cb) {
  ...
  .then(function (transId) {
    ...
    params = [uuid(), reference.project_id, cfg.fiscalYearId, cfg.periodId, cfg.transId, new Date(), cfg.description, reference.account_id, reference.cost, 0, cfg.valueExchanged, 0, reference.currency_id, null, null, id, cfg.originId, userId];
  ...
  .then(function () {
    ...
    params = [uuid(), reference.project_id, cfg.fiscalYearId, cfg.periodId, cfg.transId, new Date(), cfg.description, reference.virement_account_id, 0, reference.cost, 0, cfg.valueExchanged, reference.currency_id, null, null, id, cfg.originId, userId];
    return db.exec(sql, [params]);
  })
  ...
  .then(function (transId) {
    ...
    params = [uuid(), reference.project_id, cfg.fiscalYearId, cfg.periodId, cfg.transId, new Date(),
